...
def display_examples(model, input, num_images=5, size=None, crop_center=False,
                     crop_largest_rect=False, preprocess_func=None, save_path=None,m_dir=None):
    """
    ...
    for rotated_image, true_angle, predicted_angle in zip(x_rot, y, y_pred):
        ...
        #--------------------------------------------------------------------------
        aman+=1
        save_image(original_image,rotated_image,corrected_image,aman,m_dir)
        #--------------------------------------------------------------------------
        fig_number += 1
